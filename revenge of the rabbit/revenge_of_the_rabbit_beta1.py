...
bg=pygame.transform.scale(b,(800,490))
...
class turtle(pygame.sprite.Sprite):
    def __init__(self,type_,x,y,distance,range_,freq):
        self.x=x
        self.y=y*80-25
        self.type=type_
        if type_==1:
...
shoal=[turtle(2,600,6,200,200,40),turtle(2,0,5,300,200,30),turtle(2,170,1,200,200,40),
...
carrotbox=[carrotrestock(125,3),carrotrestock(550,4)]
